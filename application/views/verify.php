                        ...
                        <div class="panel-body">
                            ...
                            <div class="">
                                <div class="panel-group" id="accordion">
                                    Check your email and click the activation link to continue logging in.
                                                    ...
                                                    <div>
                                                        ...
                                                        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url() . 'shop/validate_credentials' ?>">
                                                            <div class="form-group">
                                                                <div class="col-sm-12">
                                                                    <input autofocus type="text" name="username" class="form-control" placeholder="Username or Email">
                                                                </div>
                                                            </div>
                                                            <br>
                                                            <h4>Password</h4>
