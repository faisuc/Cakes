                    ...
                    <div id="sidebar"  class="nav-collapse ">
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li class="active" ><a  href="<?php echo base_url() . 'shop/addItem' ?>">Add product</a></li>
...
//                    
                    ?>
                    <form action="<?php echo base_url() . 'shop/add_product'; ?>" enctype="multipart/form-data" method="post" role="form">
