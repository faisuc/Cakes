            ...
            <section id="container" >
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li class="active"><a  href="<?php echo base_url() . 'shop/editProd'?>">Update products</a></li>
                ...
                <section id="main-content">
                    <section class="wrapper">
                        ...
                        <form action="<?php echo base_url() . 'shop/updateItm/'. $item->prod_id ?>" enctype="multipart/form-data" method="post" role="form">
