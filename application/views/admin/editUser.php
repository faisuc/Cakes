                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <li class="active"><a  href="<?php echo base_url() . 'shop/edituser' ?>">View/ Edit all users</a></li>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <tr class="gradeC">
                                            ...
                                            <td><?php echo $user->status; ?></td>
                                                <td class="centex hidden-phone"><a href="<?php echo base_url().'shop/edituacc/'.$user->id ?>"><u>EDIT</u></a></td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                            </table>
