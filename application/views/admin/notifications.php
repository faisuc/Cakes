                ...
                <aside>
                    <div id="sidebar"  class="nav-collapse ">
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            <li>
                                <a class="active" href="<?php echo base_url() . 'AdminPage' ?>">
                    ...
                    <?php
                        ...
                        if ($field == 'user') {
                            ...
                            foreach ($ordersid as $order) {
                                ...
                                $query = $this->db->query("SELECT * FROM `cart` WHERE `order_id2` = $order");

                                $prodid = $query->row()->product_id2;

                                $prod = $this->db->query("SELECT * FROM `product` WHERE `prod_id` = $prodid");

                                $total = $query->row()->qty2 * $query->row()->total2;

                                echo "<tr>";
                                echo "<td>" . $prod->row()->prod_name . "</td>";
                                echo "<td>" . $query->row()->qty2 . "</td>";
                                echo "<td>" . $total . "</td>";
                                echo "</tr>";
