                            ...
                            <form action="<?php echo base_url() . 'shop/comment'; ?>" id="contact-form" role="form" method="post">
                                ...
                                <div class="text-fields">
                                    <div class="float-input">
                                        <input name="uname" id="" type="text" placeholder="Username">
                                        <span><i class="fa fa-user"></i></span>
                                    </div>
                                    <div class="float-input">
                                        <input name="email" id="" type="text" placeholder="E-mail">
                                        <span><i class="fa fa-envelope-o"></i></span>
                                    </div>
                                    <div class="float-input">
                                        <input name="phone" id="" type="text" placeholder="Phone Number">
