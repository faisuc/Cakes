                ...
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="text">
                        <p class="papa">
                            Announcement</p>
                        <span class="spam">
                            <a href="<?php echo base_url();?>Article/1"><u>Read this article</u></a>
                        </span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="text">
                        <p class="papa">
                            Announcement</p>
                        <span class="spam">
                            <a href="<?php echo base_url();?>Article/2"><u>Read this article</u></a>
                        </span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="text">
                        <p class="papa">
                            Announcement</p>
                        <span class="spam">
                            <a href="<?php echo base_url();?>Article/3"><u>Read this article</u></a>
                        </span>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6">
                    ...
                    <div class="text">
                        <p class="papa">
                            Announcement</p>
                        <span class="spam">
                            <a href="<?php echo base_url();?>Article/4"><u>Read this article</u></a>
                        </span>
                    </div>
                </div>
            </div>
