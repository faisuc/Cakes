    ...
    <div class="row members">
        <div class="">
            ...
            <div class="text">
                ...
                <span>
                Dorissimo Pastries is a newly established café and pastry shop. Before the pastry shop was founded by Doriss Pilares Monsanto on May 2014, the owner was already in the pastry business for the past 10 years as a Christmas Baker, selling boxes of cookies during the Christmas season. Dorissimo Pastries provides the following services: ordering of existing products, customization of cakes and walk through orders. The shop uses healthy recipes in order to provide the consumer satisfaction for every service. </span>
...
<div class="prize">
    <div class="container">
        <h1>FREE DELIVERY WITHIN METRO MANILA. SHOP WITH US NOW!</h1>
    </div>
</div>
<!--end-prize-->
<!--footer-->
