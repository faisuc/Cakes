                        ...
                        <ul class="nav pull-right top-menu">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu extended logout">
                                    ...
                                    <li><a href="<?php echo base_url("shop/logout"); ?>"><i class="fa fa-key"></i> Log Out</a></li>
                                </ul>
                            </li>
                    ...
                    <div id="sidebar"  class="nav-collapse ">
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li><a  href="basic_table.html">Home</a></li>
                                    <li><a  href="responsive_table.html">Services</a></li>
                                    <li><a  href="basic_table.html">Menu</a></li>
                                    <li><a  href="responsive_table.html">Contacts</a></li>
                                </ul>
                            </li>
                        </ul>
                        <!-- sidebar menu end-->
            ...
            <section id="main-content">
                <section class="wrapper">
                    ...
                    <?php
                        ...
                        if ($field == 'user') {
                            echo "<h4>New Registered User</h4>";
                            echo "<b>Name :</b> " . $notif[0]->fname . " " . $notif[0]->lname . "<br />";
                            echo "<b>Email :</b> " . $notif[0]->email;                            
                        } else if ($field == "order") {

                            $userid = $notif[0]->user_id;
                            $orders = $notif[0]->notif_id;

                            $query = $this->db->query("SELECT * FROM `users` WHERE `id` = $userid");
                            $name = $query->row()->fname . " " . $query->row()->lname;

                            echo "<h4>New Order has been purchased</h4>";
                            echo "<b>Name: </b>" . $name . "<br />";
                            
                            $ordersid = explode("-", $orders);

                            echo "<table border=1>";
                            echo "<tr><th>Product Name</th><th>Qty</th><th>Order Total</th></tr>";

                            foreach ($ordersid as $order) {

                                $query = $this->db->query("SELECT * FROM `order` WHERE `order_id` = $order");

                                $prodid = $query->row()->product_id;

                                $prod = $this->db->query("SELECT * FROM `product` WHERE `prod_id` = $prodid");

                                $total = $query->row()->qty * $query->row()->total;

                                echo "<tr>";
                                echo "<td>" . $prod->row()->prod_name . "</td>";
                                echo "<td>" . $query->row()->qty . "</td>";
                                echo "<td>" . $total . "</td>";
                                echo "</tr>";
