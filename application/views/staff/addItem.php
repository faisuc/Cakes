                    ...
                    <div id="sidebar"  class="nav-collapse ">
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <li class="active" ><a  href="<?php echo base_url() . 'shop/addItemS'?>">Add product</a></li>
...
//                    }
//                    ?>
                    <form action="<?php echo base_url() . 'shop/add_productS'; ?>" enctype="multipart/form-data" method="post" role="form">
                        <div class="form-group col-xs-4">
                            <h3>Product Information</h3>
                            Name
                            <input type="text" class="form-control" autofocus name="item_name"><br>
                            Description
                            <input type="text" class="form-control" autofocus name="item_desc"><br>
                            Price Whole
                            ...
                            <div class="input-group">
                                <span class="input-group-addon">₱</span>
                                <input type="text" class="form-control" aria-describedby="basic-addon1" name="price2">
                            </div><br>
                            Quantity
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <select name="cat" class="form-control col-xs-1">
                            ...
                            <input type="file" class="form-control" name="userfile2"><br>
                            <input type="file" class="form-control" name="userfile3"><br>
                            <input type="file" class="form-control" name="userfile4"><br>
