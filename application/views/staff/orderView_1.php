               ...
               <aside>
                    <div id="sidebar"  class="nav-collapse ">
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            ...
                            <li class="sub-menu">
                                <a class="active" href="<?php echo base_url() . 'orderViewS'?>">
                            ...
                            <div class="col-lg-12">
                                <section class="panel">
                                    <header class="panel-heading">
                                        <a href="<?php echo base_url(); ?>orderViewS">List of all Pending Orders</a> | <a href="<?php echo base_url(); ?>shop/orderViewS/approved">List of all Approved Orders</a> | <a href="<?php echo base_url(); ?>shop/orderViewS/declined">List of all Declined Orders</a>
                                    </header>
                                                    ...
                                                    <tr class="gradeC">
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($order->status2 == "pending") {
                                                                ?>
                                                                <a href="<?php echo base_url(); ?>shop/acceptorderS/<?php echo $order->order_id2; ?>" class="btn btn-success">ACCEPT</a>
                                                                <a href="<?php echo base_url(); ?>shop/declineorderS/<?php echo $order->order_id2; ?>" class="btn btn-danger">DECLINE</a>
                                                                <a data-toggle="modal" data-target="<?php echo '#modal' . $orderid ?>" class="btn btn-info">DETAILS</a>
                                                                <?php
                                                            } else if ($order->status2 == "approved") {
                                                                ?>
                                                                <a href="<?php echo base_url(); ?>shop/pendingorderS/<?php echo $order->order_id2; ?>" class="btn btn-warning">PENDING</a>
                                                                <a href="<?php echo base_url(); ?>shop/declineorderS/<?php echo $order->order_id2; ?>" class="btn btn-danger">DECLINE</a>
                                                                <a data-toggle="modal" data-target="<?php echo '#modal' . $orderid ?>" class="btn btn-info">DETAILS</a>
                                                                <?php
                                                            } else if ($order->status2 == "declined") {
                                                                ?>
                                                                <a href="<?php echo base_url(); ?>shop/acceptorderS/<?php echo $order->order_id2; ?>" class="btn btn-success">APPROVE</a>
                                                                <a href="<?php echo base_url(); ?>shop/pendingorderS/<?php echo $order->order_id2; ?>" class="btn btn-warning">PENDING</a>
                                                                <a data-toggle="modal" data-target="<?php echo '#modal' . $orderid ?>" class="btn btn-info">DETAILS</a>
                                                                <?php
                                                            }
