...
<html lang="en">
    ...
    <body>
                ...
                <aside>
                    <div id="sidebar"  class="nav-collapse ">
                        ...
                        <ul class="sidebar-menu" id="nav-accordion">
                            <li>
                                <a class="active" href="<?php echo base_url() . 'StaffPage' ?>">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <section class="panel">
                                ...
                                <div class="value">
                                    <h1 class="">
                                        <?php
                                            $query = $this->db->query("SELECT SUM(qty2) as `totalSum` FROM `cart` WHERE `status2` = 'approved'");
                                            $row = $query->row();
                                            echo $row->totalSum == "" ? 0 : $row->totalSum;
                                        ?>
                                    </h1>
                                    <p>Sales</p>
                                </div>
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <section class="panel">
                                ...
                                <div class="value">
                                    <h1 class="">
                                        <?php
                                            $query = $this->db->query("SELECT COUNT(order_id2) as `totalSum` FROM `cart` WHERE `status2` = 'pending'");
                                            $row = $query->row();
                                            echo $row->totalSum;
                                        ?>
                                    </h1>
                                    <p>Orders for Approval</p>
                                </div>
                            </section>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <section class="panel">
                                ...
                                <div class="value">
                                    <h1 class="">
                                        <?php
                                            $query = $this->db->query("SELECT SUM(total2) as `totalSum` FROM `cart` WHERE `status2` = 'approved'");
                                            $row = $query->row();
                                            echo $row->totalSum == "" ? 0 : $row->totalSum;
                                        ?>
                                    </h1>
        ...
        <script type="text/javascript">
            function countUp(count123)
            {
                var div_by = 10,
                        speed = Math.round(count123/ 20),
                        $display = $('.count123'),
                        run_count = 1,
                        int_speed = 60;
                ...
                var int = setInterval(function() {
                    if (run_count < div_by) {
                        ...
                        run_count++;
                    } else if (parseInt($display.text()) < count123) {
